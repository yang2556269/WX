...
use app\admin\controller\MsgConstant;
use app\admin\controller\ResponsePassive;
use app\admin\controller\UserManage;
class WechatRequest {
...
public static function switchType(&$request){
  ...
  return $data;
    ...
    public static function eventSubscribe(&$request){
        ...
        $content = $_SESSION['think']['welcome'];
        return ResponsePassive::text($request['fromusername'], $request['tousername'], $content);
    }
    ...
    public static function test(){
        ...
        $pc = new org\Aes\WXBizMsgCrypt($token, $encodingAesKey, $appId);
        $encryptMsg = '';
